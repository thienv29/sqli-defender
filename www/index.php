    ...
    <div class="container">
        ...
        <div class="warning">
            ...
            KHÔNG thử trên hệ thống production hoặc shared hosting.
                ...
                <div class="action-buttons" style="text-align: center; margin-bottom: 30px;">
                    <button type="button" onclick="showEducation()" class="btn btn-warning" style="padding: 15px 30px; font-size: 18px;">
                        <span>🎓</span>
                        <span>TÌM HIỂU VỀ SQL INJECTION</span>
                    </button>
                </div>
        ...
        <div id="educationModal" class="sql-modal">
            <div class="sql-modal-content">
                <div class="sql-modal-header">
                    <h3>🎓 SQL INJECTION - Hướng Dẫn Chi Tiết</h3>
